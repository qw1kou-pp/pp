...
export const Route = createFileRoute("/_layout/3")({
...
const getAdviceLevelClassName = (level: CodeAgentOptimizationAdvice["level"]) => {
  const classMap: Record<CodeAgentOptimizationAdvice["level"], string> = {
    high: "border-red-500 bg-red-950/30 text-red-100",
    medium: "border-yellow-500 bg-yellow-950/30 text-yellow-100",
    low: "border-blue-500 bg-blue-950/30 text-blue-100",
  }
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="border-t pt-4 space-y-3">
          <div>
            <h3 className="font-medium">上传代码仓库 zip</h3>
            <p className="text-sm text-gray-500">
      ...
      <div className="border rounded-lg p-4 space-y-4">
        ...
        <div className="border rounded p-4 space-y-3">
          ...
          {codeEvalTypeCompareSummaryQuery.isLoading ? (
            <div className="text-sm text-gray-500">正在加载统计结果...</div>
          ) : null}
        ...
        <div className="border rounded p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <label className="text-sm space-y-1">
              <span className="block text-gray-600">按任务类型筛选</span>
              <select
                className="border rounded px-3 py-2 w-full bg-white text-gray-900 border-gray-300"
                value={failureCaseTypeFilter}
                onChange={(event) => setFailureCaseTypeFilter(event.target.value)}
              >
                <option className="bg-white text-gray-900" value="">
                  全部类型
                </option>
                <option className="bg-white text-gray-900" value="file_overview">
                  文件概览 file_overview
                </option>
                <option className="bg-white text-gray-900" value="symbol_definition">
                  符号定义 symbol_definition
                </option>
                <option className="bg-white text-gray-900" value="symbol_reference">
                  引用定位 symbol_reference
                </option>
                <option className="bg-white text-gray-900" value="code_logic">
                  代码逻辑 code_logic
                </option>
                <option className="bg-white text-gray-900" value="bug_location">
                  Bug 定位 bug_location
                </option>
                <option className="bg-white text-gray-900" value="unknown">
                  未分类 unknown
                </option>
              </select>
            </label>
            ...
            <label className="text-sm space-y-1">
              <span className="block text-gray-600">按对比批次筛选</span>
              <select
                className="border rounded px-3 py-2 w-full bg-white text-gray-900 border-gray-300"
          ...
          {ragAgentCompareFailureAnalysisQuery.isLoading ? (
            <div className="text-sm text-gray-500">正在加载失败案例分析...</div>
          ) : null}
          ...
          {ragAgentCompareFailureAnalysisQuery.data ? (
            <div className="space-y-4">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                <div className="border rounded p-3 bg-neutral-900 text-gray-100">
                  <div className="text-xs text-gray-400">分析样例数</div>
                  <div className="text-xl font-semibold">
                ...
                <div className="border rounded p-3 bg-neutral-900 text-gray-100">
                  <div className="text-xs text-gray-400">异常样例数</div>
                  <div className="text-xl font-semibold">
                ...
                <div className="border rounded p-3 bg-neutral-900 text-gray-100">
                  <div className="text-xs text-gray-400">异常率</div>
                  <div className="text-xl font-semibold">
                ...
                <div className="border rounded p-3 bg-neutral-900 text-gray-100">
                  <div className="text-xs text-gray-400">原因类型数</div>
                  <div className="text-xl font-semibold">
              ...
              <div className="space-y-3">
                {ragAgentCompareFailureAnalysisQuery.data.data.map((item) => (
                  <div
                    key={item.id}
                    className="border rounded p-3 space-y-2 bg-neutral-900 text-gray-100"
                  >
                    <div className="flex items-start justify-between gap-3">
                      <div>
        ...
        <div className="border rounded p-4 space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <label className="text-sm space-y-1">
              <span className="block text-gray-600">优化前批次</span>
              <select
                className="border rounded px-3 py-2 w-full bg-white text-gray-900 border-gray-300"
            ...
            <label className="text-sm space-y-1">
              <span className="block text-gray-600">优化后批次</span>
              <select
                className="border rounded px-3 py-2 w-full bg-white text-gray-900 border-gray-300"
          ...
          {ragAgentCompareBatchesQuery.isLoading ? (
            <div className="text-sm text-gray-500">正在加载对比批次...</div>
          ) : null}
          ...
          {baselineCompareBatch && optimizedCompareBatch ? (
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="border rounded p-3 bg-neutral-900 text-gray-100 space-y-1">
                  <div className="text-xs text-gray-400">优化前</div>
                ...
                <div className="border rounded p-3 bg-neutral-900 text-gray-100 space-y-1">
                  <div className="text-xs text-gray-400">优化后</div>
              ...
              <div className="border rounded p-3 bg-neutral-900 text-gray-100 space-y-2">
        ...
        <div className="border rounded p-4 space-y-3">
          ...
          {experimentReportMarkdown ? (
            <div className="space-y-2">
              ...
              <pre className="border rounded p-3 bg-neutral-900 text-gray-100 text-xs whitespace-pre-wrap overflow-x-auto max-h-[600px]">
                {experimentReportMarkdown}
              </pre>
            </div>
          ) : (
        ...
        <div className="border rounded p-3 space-y-3 bg-gray-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <label className="text-sm space-y-1">
              <span className="block text-gray-600">最多扫描代码文件数 max_files</span>
              <input
                className="border rounded px-3 py-2 w-full"
                type="number"
                min={1}
            ...
            <label className="text-sm space-y-1">
              <span className="block text-gray-600">最多生成 symbol 问题数 max_symbols</span>
              <input
                className="border rounded px-3 py-2 w-full"
                type="number"
                min={1}
              ...
              {ragEvalCasesQuery.data.data.length === 0 ? (
                ...
                <div className="space-y-3">
                  {ragEvalCasesQuery.data.data.map((evalCase) => {
                    ...
                    return (
                      <div key={evalCase.id} className="border rounded p-3 space-y-2">
                        <div className="flex items-start justify-between gap-3">
                          <div className="space-y-1">
                            <div className="font-medium">
                              {evalCase.question}
